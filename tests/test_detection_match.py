...
def test_true_detected_catalog():
    ...
    np.testing.assert_array_equal(
        det[1]["d_min"], [0.14142135623730953], err_msg="Incorrect min d algorithm 2"
    )
...
def one_undetected():
    ...
    np.testing.assert_array_equal(
        det[0]["num_detections2"], [0, 1], err_msg="Incorrect detection algorithm 2"
    )
    np.testing.assert_array_equal(
        det[0]["closest_det_id1"],
        [0, 0],
    ...
    np.testing.assert_array_equal(
        det[1]["match_true_id2"], [1], err_msg="Incorrect match algorithm in 2"
    )
    np.testing.assert_array_equal(
        det[1]["match_galtileid1"], [100], err_msg="Incorrect match algorithm 1"
    )
    np.testing.assert_array_equal(
        det[1]["match_galtileid2"], [101], err_msg="Incorrect match algorithm 2"
    )
    np.testing.assert_array_equal(
        det[1]["dSigma_min"], [0.5], err_msg="Incorrect min dSigma algorithm 1"
    )
    np.testing.assert_array_equal(
